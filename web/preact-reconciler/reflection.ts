...
export const getSuspenseInstanceFromFiber = (
  _fiber: Fiber,
): SuspenseInstance | null => null;
...
export const findCurrentFiberUsingSlowPath = (_fiber: Fiber): Fiber | null =>
  null;
export const findCurrentHostFiber = (_parent: Fiber): Fiber | null => null;
export const findCurrentHostFiberWithNoPortals = (
  _parent: Fiber,
): Fiber | null => null;
export const isFiberSuspenseAndTimedOut = (_fiber: Fiber): boolean => false;
export const doesFiberContain = (
  _parentFiber: Fiber,
  _childFiber: Fiber,
): boolean => false;
